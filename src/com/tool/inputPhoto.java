...
//改
		...
		individualClassVO.setC_detail("肌力循環式訓練　團結精實肌肉不走鐘\r\n" + 
				...
				"提升反應靈敏協調感、身體強壯最抗老','健美研習','台北市松山區民生東路-給力健身房");
		...
		individualClassVO.setC_detail("肌力循環式訓練　團結精實肌肉不走鐘\r\n" + 
				...
				"心肺功能提高，降低疲勞、增加身體基礎代謝率\r\n" + 
				"燃脂暢快揮汗，緊實線條，打造勻稱線條體態\r\n" + 
				"提升反應靈敏協調感、身體強壯最抗老','健美研習','台北市松山區民生東路-給力健身房");		individualClassVO.setC_status(1);
		individualClassVO.setP_coin(1500);
		dao1.updatePIC(individualClassVO);
